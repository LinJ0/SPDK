...
#define TRACE_GROUP_NVME_IO     0xF
...
/* NVMe io tracepoint definitions */
#define TRACE_NVME_IO_SUBMIT      SPDK_TPOINT_ID(TRACE_GROUP_NVME_IO, 0x0)
#define TRACE_NVME_IO_COMPLETE    SPDK_TPOINT_ID(TRACE_GROUP_NVME_IO, 0x1)
